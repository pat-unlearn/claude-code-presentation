...
const phases = [
  ...
  },
  {
    ...
    content: [
      ...
      '',
      'Theme & Narrative:',
      '- Hook: "The Developer Crisis" problem - context loss, inefficiency, generic AI responses',
      ...
      '- Use smart phone app store metaphor to explain MCP servers',
      '',
  ...
  },
  {
    ...
    content: [
      ...
      '2. Create slide structure with 3-act narrative',
